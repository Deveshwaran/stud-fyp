...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="addqrcode.php" id="qrcode">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="manageList(admin).php">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="viewReport(admin).php">

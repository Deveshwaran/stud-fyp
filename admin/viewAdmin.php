<?php
	...
	$query1 = "SELECT * FROM admin ORDER BY admin_ID";
	...
	<div class="table">
        ...
        <div class="cell">
			...
			<div class="container">
				...
				<button onclick="window.location.href='viewAdmin.php'" class="select">View Admin</button>
				...
				<b>Number of user:</b>
				<?php 
					$query = "SELECT COUNT(admin_ID) as totalUser FROM admin_admin";

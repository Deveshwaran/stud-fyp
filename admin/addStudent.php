        ...
        <div class="table">
            ...
            <div class="cell">
				...
				<form action="addStudent.php" method="post">
					...
					<label for="id"><b style="margin-right: 70px">Student ID:</b></label>
					...
					<label for="department"><b style="margin-right: 57px">Department:</b></label>
					...
					<button name="createStu" value="Sign Up" style="margin-left: 35%">Sign Up</button>

        ...
        <div class="table">
            ...
            <div class="cell">
				...
				<form action="addLecturer.php" method="post">
					<h2 style="text-align: center">Add Lecturer</h2>
					...
					<label for="address"><b style="margin-right: 91px">Address:</b></label>
					...
					<button name="createLec" value="Sign Up" style="margin-left: 35%">Sign Up</button>

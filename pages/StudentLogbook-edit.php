...
<?php 
  if(isset($_POST['submit'])){
    ...
    $strSQL = "UPDATE logbook SET SupervisorFeedback";
...
<section class="section profile">
  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="row ">
            <div class="col-lg-3 col-md-4 label">Supervisor's Feedback</div>
            <div class="col-lg-9 col-md-8"><?php echo $row['SupervisorFeedback']!='' ? $row['SupervisorFeedback'] : 'None';?></div>
      </div>

      <div class="row ">
            <div class="col-lg-3 col-md-4 label">Evaluator's Feedback</div>
            <div class="col-lg-9 col-md-8"><?php echo $row['EvaluatorFeedback']!='' ? $row['EvaluatorFeedback'] : 'None';?></div>
      </div>
      
      <form method="post">
        <input type="text" class="comment" id="comment-box" text-align="top" placeholder="Enter comment">
          <br>
          <br>
        <button type="submit" value="submit" name="submit" class="btn btn-primary">Post feedback</button>
